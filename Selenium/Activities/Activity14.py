...
with webdriver.Firefox(service=service) as driver:
    ...
    second_row_second_cell_before_sort = driver.find_element(
        By.XPATH, "//table[@id='sortableTable']/tbody/tr[2]/td[2]"
    )
    # Print the cell value
    print(
        "Cell value at second row and second column: ",
    ...
    second_row_second_cell_after_sort = driver.find_element(
        By.XPATH, "//table[@id='sortableTable']/tbody/tr[2]/td[2]"
    )
    # Print the cell value
    print(
        "Cell value at second row and second column Again: ",
